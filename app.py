...
try:
    ...
    team_data, global_activity_types, global_tags, global_designations, global_custom_fields, taxonomy_map, projects_data, tasks_data, logs_data, ledger_data = [], [], [], [], [], {}, [], [], [], []
    ...
    if proj_details:
        ...
        with tab_overview:
            ...
            with col_vitals:
                ...
                # Derive start date from earliest ledger entry or creation
                start_date = "N/A"
                if not proj_ledger.empty:
        ...
        # Tab 2: Design & Deliverables (Placeholder)
        with tab_deliverables:
            st.info("Module under construction in Phase 2.")

        # Tab 3: Field & Execution (Placeholder)
        with tab_field:
            st.info("Module under construction in Phase 2.")

        # 4. Tab 4: Comms & Approvals
        with tab_comms:
        ...
        # Tab 5: Document Vault (Placeholder)
        with tab_vault:
            st.info("Module under construction in Phase 2.")
